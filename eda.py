...
Kết quả:
    - In ra số lượng ảnh theo class trong dataset/raw, dataset/augmented, dataset/split
    ...
    - Lưu báo cáo và hình ảnh vào logs/
"""
...
def main():
    ...
    print("  - Xem eda_report.txt cùng các file CSV và PNG trong logs/.")
